...
namespace GUF {
    ...
    void Window::setSize(int width, int height) {
        ...
        gtk_window_set_default_size(GTK_WINDOW (getGtkObject<GtkWindow*>()), width, height);
    }

    void Window::setPosition(GtkWindowPosition windowPosition) {
        gtk_window_set_position(getGtkObject<GtkWindow*>(), windowPosition);
    }
    ...
    void Window::setTitle(const std::string_view &title) {
        ...
        gtk_window_set_title(GTK_WINDOW (getGtkObject<GtkWindow*>()), title.data());
    }

    std::string Window::getTitle() {
        return gtk_window_get_title(GTK_WINDOW (getGtkObject()));
    }
